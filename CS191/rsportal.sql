...
proposal_id INT(5) AUTO_INCREMENT NOT NULL, 
user_id INT(5) NOT NULL,
title VARCHAR(20) NOT NULL, 
proposal BLOB NOT NULL, 
abstract TEXT NOT NULL, 
fundingreq NUMERIC(12,2) NOT NULL,
startdate DATE NOT NULL, 
enddate DATE NOT NULL, 
FOREIGN KEY (user_id) REFERENCES users(user_id),
PRIMARY KEY (proposal_id));

CREATE TABLE updesignation(
updesignation_id INT(5) AUTO_INCREMENT NOT NULL,
title VARCHAR(30) NOT NULL, 
description TEXT, 
PRIMARY KEY (updesignation_id));

CREATE TABLE proponent(
proponent_id INT(5) AUTO_INCREMENT NOT NULL, 
proponent_name VARCHAR(20) NOT NULL,
emailadd VARCHAR(20), 
contactnum INT(11), 
officeadd VARCHAR(30), 
updesignation_id INT(5) NOT NULL,
FOREIGN KEY (updesignation_id) REFERENCES updesignation(updesignation_id), 
PRIMARY KEY (proponent_id));

CREATE TABLE user_roles(
user_role_id INT(5) AUTO_INCREMENT NOT NULL,
...
proposes_id INT(5) AUTO_INCREMENT NOT NULL, 
proposal_id INT(5) NOT NULL,
proponent_id INT(5) NOT NULL, 
FOREIGN KEY (proposal_id) REFERENCES proposals(proposal_id),
FOREIGN KEY (proponent_id) REFERENCES proponent(proponent_id), 

...
title VARCHAR(20) NOT NULL, proposal MEDIUMBLOB NOT NULL, 
filesize INT(20) NOT NULL, 
filename VARCHAR(20) NOT NULL,  
filetype VARCHAR(20) NOT NULL, abstract TEXT NOT NULL, fundingreq NUMERIC(12,2) NOT NULL,
status VARCHAR(50) default 'PENDING', status_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP, startdate DATE NOT NULL, enddate DATE NOT NULL, PRIMARY KEY (proposal_id));
...
review_id INT(5) AUTO_INCREMENT NOT NULL,
...
insert into proposals(title, proposal, abstract, filename, filesize, filetype, fundingreq, startdate, enddate) values('Test 1', 'PROPOSAL 1', 'ASDF', 'Hi1', 10, 'pdf', 10000, now(), now());
insert into proposals(title, proposal, abstract, filename, filesize, filetype, fundingreq, startdate, enddate) values('Test 2', 'PROPOSAL 2', 'ASDF2', 'Hi2', 10, 'pdf', 20000, now(), now());
insert into proposals(title, proposal, abstract, filename, filesize, filetype, fundingreq, startdate, enddate) values('Test 3', 'PROPOSAL 3', 'ASDF3', 'Hi3', 10, 'pdf', 30000, now(), now());
insert into proposals(title, proposal, abstract, filename, filesize, filetype, fundingreq, startdate, enddate) values('Test 4', 'PROPOSAL 4', 'ASDF4', 'Hi4', 10, 'pdf', 40000, now(), now());
insert into proposals(title, proposal, abstract, filename, filesize, filetype, fundingreq, startdate, enddate) values('Test 5', 'PROPOSAL 5', 'ASDF5', 'Hi5', 10, 'pdf', 50000, now(), now());
insert into proposals(title, proposal, abstract, filename, filesize, filetype, fundingreq, startdate, enddate) values('Test 6', 'PROPOSAL 6', 'ASDF6', 'Hi6', 10, 'pdf', 60000, now(), now());
